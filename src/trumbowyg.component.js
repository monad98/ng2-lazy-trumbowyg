...
var trumbowyg_service_1 = require("./trumbowyg.service");
...
var Trumbowyg = (function () {
    function Trumbowyg(el, trumbowygService) {
        ...
        this.savedContent = new core_1.EventEmitter();
        this.content$ = new BehaviorSubject_1.BehaviorSubject("");
    }
    Object.defineProperty(Trumbowyg.prototype, "initialContent", {
        set: function (value) {
            if (value) {
    ...
    Trumbowyg.prototype.ngOnInit = function () {
        var _this = this;
        this.loaded$ = this.trumbowygService.loaded().filter(function (loaded) { return loaded; });
        this.loadedSubscription = this.loaded$
            .do(function () {
            var el = jQuery(_this.el.nativeElement).find('#ng-trumbowyg');
            el.trumbowyg();
            if (_this.liveUpdate) {
                el.trumbowyg().on('tbwchange', function () {
                    _this.savedContent.emit(el.trumbowyg('html'));
                });
            }
        })
            .switchMap(function () { return _this.content$; })
...
__decorate([
    core_1.Input('initialContent'),
    __metadata("design:type", String),
    __metadata("design:paramtypes", [String])
], Trumbowyg.prototype, "initialContent", null);
__decorate([
    core_1.Input('togglePreview'),
